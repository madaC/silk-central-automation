...
const getParameters = async (test: OctaneTest,
                             testContainerAppModule: OctaneApplicationModule,
                             suiteId: string,
                             suiteRunId: string,
                             sourceControlProfile: SourceControlProfile | undefined
    ...
    let predefinedParams: { [key: string]: string } = await getPredefinedParameters(test, testContainerAppModule,
        suiteId, suiteRunId, sourceControlProfile);
    ...
    if (csvParametersAttachment) {
        ...
        for (let iteration of iterations) {
            for (let predefinedParam in predefinedParams) {
                iteration[predefinedParam] = predefinedParams[predefinedParam];
            }
        }
        ...
        iterations.push(predefinedParams);
    }
