...
const createCommand = (methodName, octaneTestName, classNames, totalClasspath, runnerJarPath) => {
    ...
    if (methodName === null && classNames == null) {
        command = 'java -cp "' + totalClasspath + ";" + runnerJarPath + '" com.microfocus.adm.almoctane.migration.plugin_silk_central.junit.JUnitCmdLineWrapper ' + "RunMeAsAJar" + ' ' + null + ' ' + octaneTestName
    } else if (methodName === null && classNames != null && classNames.split(" ").length > 0) {
        command = 'java -cp "' + totalClasspath + ";" + runnerJarPath + '" com.microfocus.adm.almoctane.migration.plugin_silk_central.junit.JUnitCmdLineWrapper "' + classNames + '" ' + null + ' ' + octaneTestName
    } else if (methodName != null && classNames != null && classNames.split(" ").length > 0) {
        command = 'java -cp "' + totalClasspath + ";" + runnerJarPath + '" com.microfocus.adm.almoctane.migration.plugin_silk_central.junit.JUnitCmdLineWrapper "' + classNames + '" ' + methodName + ' ' + octaneTestName
    } else {
